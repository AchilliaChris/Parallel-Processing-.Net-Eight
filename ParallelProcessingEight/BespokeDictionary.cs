...
namespace ParallelProcessingEight
{
    public class BespokeDictionary : IBespokeDictionary
    {
        ...
        public async Task<int> ParallelForVat(Double rate)
        {
        ...
        public async Task<int> ParallelForOptionsVat(ParallelOptions parallelOptions, Double rate)
        {
            int size = widgets.Count();
        ...
        public async Task<int> ParallelForEachVat(Double rate)
        {
            Double multiplier = rate + 1;
        ...
        public async Task<int> ParallelForEachOptionsVat(ParallelOptions parallelOptions, Double rate)
        {
            Double multiplier = rate + 1;
            int count = widgets.Count();
