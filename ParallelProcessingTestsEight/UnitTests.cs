...
using ParallelProcessingEight;

namespace ParallelProcessingTestsEight
{
    public class UnitTests
    {
        ...
        public async Task ParralelForVat_Returns_Size()
        {
            var dict = new BespokeDictionary();
            dict.MakeWidgets(20);
            int returned = await Task.Run(() => dict.ParallelForVat(0.1));
        ...
        public async Task ParralelForVat_On_Empty_Dictionary_Returns_Zero()
        {
            var dict = new BespokeDictionary();
            dict.widgets = new ConcurrentDictionary<string, Widget>();
            int returned = await dict.ParallelForVat(0.1);
        ...
        public async Task ParralelForOptionsVat_Returns_Size()
        {
            ...
            int returned = await dict.ParallelForOptionsVat(options, 0.1);
        ...
        public async Task ParralelForEachVat_Returns_Size()
        {
            var dict = new BespokeDictionary();
            dict.MakeWidgets(15);
            int returned = await dict.ParallelForEachVat(0.2);
        ...
        public async Task ParralelForEachOptionsVat_Returns_Size()
        {
            ...
            int returned = await dict.ParallelForEachOptionsVat(options, 0.2);
